...
return [
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_products,write_products,read_checkouts, write_checkouts,read_script_tags, write_script_tags,read_customers, write_customers,read_orders,read_themes'),
